###### BS--S BOX #######
######L=[[1,2,3],[4,5,6],[7,8,9]]
######f=[(i,row.index(5)) for i, row in enumerate(L) if 5 in row] for reverse mapping of sbox to row column
#f=[(i,row.index('8b')) for i, row in enumerate(sbox) if '8b' in row]
